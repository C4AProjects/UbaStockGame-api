...
class dbHelper {
    ...
    function delete($table, $where){
     ...
     public function GetProductName($pumpid,$nozzelid){
         $stmt = $this->db->prepare("SELECT ps.productid,p.productdesc FROM products p INNER JOIN 
            pumpsetup ps ON ps.productid=p.productid where ps.pumpid=".$pumpid." and ps.nozzelid=".$nozzelid);
      $a = array();
